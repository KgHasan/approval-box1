...
def banner():
	print(f'''\t{M} 
	 ...
	 [➣] OWNER :        ASRAFUL ISLAM HASAN {SANTO}
	 [➣] ADMIN:          {HASAN & SANDO}
	 [➣] VERSION :       0.4
	 
	 \x1b[92;1mTHIS TOOL CRATE BY HASAN & SANTO
...
def xoshnaw():
  ...
  try:
    httpCaht = requests.get("https://github.com/KgHasan/approval-box1/blob/main/wow.txt").text
    if id in httpCaht:
